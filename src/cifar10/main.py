...
from src.cifar10.bnas_child import MicroChild
...
DEFINE_string("output_dir", "outputs-search", "")
...
DEFINE_integer("child_num_pool", 2, "")
DEFINE_integer("child_num_enhance", 2, "")
...
def get_ops(images, labels):
  ...
  child_model = ChildClass(
    ...
    num_pool = FLAGS.child_num_pool,
    num_cells=FLAGS.child_num_cells,
    num_enhance=FLAGS.child_num_enhance,
  ...
  child_ops = {
    ...
    "normal_arc": child_model.normal_arc,
    ...
    with tf.train.SingularMonitoredSession(
      config=config, hooks=hooks, checkpoint_dir=FLAGS.output_dir) as sess:
        ...
        while True:
          ...
          curr_time = time.time()
          #print("normal:", nor_arc)
          #print("reduce:", red_arc)
